...
Tesis de maestría (MCID, FIC-UAT). El objetivo es clasificar el sentimiento de reseñas de productos agrícolas de Amazon en tres clases: positivo, neutro y negativo. El enfoque etiqueta el corpus con un ensamble de tres LLMs y luego entrena clasificadores clásicos supervisados sobre esas etiquetas.
